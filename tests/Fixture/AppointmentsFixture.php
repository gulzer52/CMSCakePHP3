...
class AppointmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'doctors_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'patient_id' => 1,
                'doctors_id' => 1,
                'appointment_date' => '2020-10-06',
                'created' => '2020-10-06 16:05:53',
            ],
        ];
        parent::init();
    }
